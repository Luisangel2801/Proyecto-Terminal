...
\section{Desarrollo del Proyecto}
    \subsection{Desarrollo del circuito de ECG}
        ...
        \subsubsection{Amplificador de Instrumentación AD620}
            ...
            Buscamos obtener una ganancia igual a 21 porque la señal de ECG tiene una amplitud de $100 mV_{pp}$ y se requiere una amplitud de $2.1 V_{pp}$ para ser procesada por el microcontrolador. Despejando la ecuación~\ref{eq:ganancia} para $R_G$ se obtiene que la resistencia a utilizar es de $2.5 k\Omega$.
            ...
            Teniendo de esta manera una ganancia teórica de 20.76.
